(module
 ...
 (import "env" "GetRandom" (func $GetRandom (param i32 i32) (result i32)))
 ...
 (table 9 9 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $__cxx_global_array_dtor $_ZN5eosio4dice9startgameEx $_ZN5eosio4dice4playExxx $_ZN5eosio4dice8stopgameEv $sn_write $__stdio_close $__stdout_write $__stdio_seek)
 (memory $0 1)
 (data (i32.const 4) "\00t\00\00")
 (data (i32.const 32) "creator status\00")
 (data (i32.const 48) "game already exists\00")
 (data (i32.const 80) "deposit must be positive\00")
 (data (i32.const 112) "fail to frozen coins\00")
 (data (i32.const 144) "write\00")
 (data (i32.const 160) "game is not active\00")
 (data (i32.const 192) "amount must be positive\00")
 (data (i32.const 224) "number must be within range of 2~97\00")
 (data (i32.const 272) "direction must be 0 or 1\00")
 (data (i32.const 304) "amount is too big\00")
 (data (i32.const 336) "GetRandom length error\00")
 (data (i32.const 368) "rand num:%lld\n\00")
 (data (i32.const 384) "fail to transfer frozen coins\00")
 (data (i32.const 416) "fail to active coins\00")
 (data (i32.const 448) "you win\n\00")
 (data (i32.const 464) "you lose\n\00")
 (data (i32.const 480) "round:%lld\00")
 (data (i32.const 496) "read\00")
 (data (i32.const 512) "get\00")
 (data (i32.const 528) "game can only be stopped by creator\00")
 (data (i32.const 576) "withdraw\n\00")
 (data (i32.const 592) "stop game\n\00")
 (data (i32.const 608) "round;%lld,player:%s,amount:%lld,guess_num:%lld,result_num:%lld,is_player_win:%d,\00")
 (data (i32.const 704) "onerror\00")
 (data (i32.const 720) "eosio\00")
 (data (i32.const 736) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 800) "\00\00\00\00")
 ...
 (data (i32.const 12116) "X/\00\00")
 (data (i32.const 12120) "\05\00\00\00\00\00\00\00\00\00\00\00\06\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\07\00\00\00\08\00\00\00\f8/\00\00\00\04\00\00\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\n\ff\ff\ff\ff\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (export "_ZN5eosio4dice4playExxx" (func $_ZN5eosio4dice4playExxx))
 ...
 (export "_ZN5eosio4dice12getroundinfoEx" (func $_ZN5eosio4dice12getroundinfoEx))
 ...
 (func $_ZN5eosio4dice4playExxx (type $FUNCSIG$vijjj) (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i64)
  (local $4 i32)
  (local $5 i64)
  (local $6 i64)
  (local $7 i64)
 ...
 (func $_ZN5eosio4dice12getroundinfoEx (param $0 i32) (param $1 i64)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN5boost3pfr6detail19for_each_field_implINS1_14sequence_tuple5tupleIJRxRNSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEES5_S5_S5_RbEEEZN5eosiorsINSG_10datastreamIPcEENSG_4dice9roundinfoELPv0EEERT_SP_RT0_EUlSP_E_JLj0ELj1ELj2ELj3ELj4ELj5EEEEvSP_OSQ_NS6_16integer_sequenceIjJXspT1_EEEENS6_17integral_constantIbLb0EEE (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (i32.store offset=4
  ...
  (block $label$13
   ...
   (block $label$21
    (block $label$22
     ...
     (drop
      (call $_ZN5eosio14execute_actionINS_4diceES1_JxxxEEEbPT_MT0_FvDpT1_E
       (i32.add
        (get_local $9)
        (i32.const 56)
       )
 ...
 (func $_ZN5eosio14execute_actionINS_4diceES1_JxxxEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i64)
  (local $5 i64)
