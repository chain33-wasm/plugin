(module
 ...
 (data (i32.const 128) "Contract DB write and read for Hello , \00")
 (data (i32.const 176) "\nWelcome to use our wasm contract platform!\00")
 (data (i32.const 224) "It\'s developed by hezhengjun of Chain33.\n\00")
 (data (i32.const 272) "wasm contract key:Hello chain33.\00")
 (data (i32.const 320) "wasm contract value:Good luck!\00")
 (data (i32.const 352) "Contract DB retrieve value is: \00")
 (data (i32.const 384) "\90\01\00\00")
