	.text
	.file	"/tmp/tmp.IMItcsDUIQ/linked.bc"
...
_ZN5hello2hiEy:
	...
	i32.sub 	$push155=, $pop123, $pop124
	tee_local	$push154=, $10=, $pop155
	i32.store	__stack_pointer($pop125), $pop154
	copy_local	$push153=, $10
	tee_local	$push152=, $9=, $pop153
	i64.store	16($pop152), $1
	i32.const	$push129=, 32
	i32.add 	$push130=, $9, $pop129
	i32.const	$push131=, 16
	i32.add 	$push132=, $9, $pop131
	call    	_ZNK5eosio4name9to_stringEv@FUNCTION, $pop130, $pop132
	i32.load	$2=, 40($9)
	i32.load8_u	$4=, 32($9)
	i32.const	$push0=, .L.str.3
	call    	prints@FUNCTION, $pop0
	i32.const	$push133=, 32
	i32.add 	$push134=, $9, $pop133
	i32.const	$push1=, 1
	i32.or  	$push3=, $pop134, $pop1
	i32.const	$push151=, 1
	i32.and 	$push2=, $4, $pop151
	i32.select	$push4=, $2, $pop3, $pop2
	call    	prints@FUNCTION, $pop4
	block   	
	i32.load8_u	$push5=, 32($9)
	i32.const	$push150=, 1
	i32.and 	$push6=, $pop5, $pop150
	i32.eqz 	$push219=, $pop6
	br_if   	0, $pop219
	i32.const	$push7=, 40
...
.LBB5_2:
	...
	i64.const	$push15=, 0
	i64.store	32($9), $pop15
	block   	
	block   	
	block   	
	i32.const	$push16=, .L.str.6
	i32.call	$push157=, strlen@FUNCTION, $pop16
	tee_local	$push156=, $2=, $pop157
	i32.const	$push17=, -16
	i32.ge_u	$push18=, $pop156, $pop17
	br_if   	0, $pop18
	block   	
	block   	
	block   	
	i32.const	$push19=, 11
	i32.ge_u	$push20=, $2, $pop19
	br_if   	0, $pop20
	i32.const	$push26=, 1
	i32.shl 	$push27=, $2, $pop26
	i32.store8	32($9), $pop27
	i32.const	$push137=, 32
	i32.add 	$push138=, $9, $pop137
	i32.const	$push158=, 1
	i32.or  	$4=, $pop138, $pop158
	br_if   	1, $2
	br      	2
.LBB5_5:
	end_block
	...
	i32.const	$push23=, -16
	i32.and 	$push160=, $pop22, $pop23
	tee_local	$push159=, $3=, $pop160
	i32.call	$4=, _Znwj@FUNCTION, $pop159
	i32.const	$push24=, 1
	i32.or  	$push25=, $3, $pop24
	i32.store	32($9), $pop25
	i32.store	40($9), $4
	i32.store	36($9), $2
.LBB5_6:
	end_block
	i32.const	$push28=, .L.str.6
	i32.call	$drop=, memcpy@FUNCTION, $4, $pop28, $2
.LBB5_7:
	end_block
	i32.add 	$push29=, $4, $2
	i32.const	$push30=, 0
	...
	i32.const	$push163=, 0
	i32.store	0($pop32), $pop163
	i64.const	$push33=, 0
	i64.store	16($9), $pop33
	i32.const	$push34=, .L.str.7
	i32.call	$push162=, strlen@FUNCTION, $pop34
	tee_local	$push161=, $2=, $pop162
	i32.const	$push35=, -16
	i32.ge_u	$push36=, $pop161, $pop35
	br_if   	1, $pop36
	block   	
	block   	
	block   	
	i32.const	$push37=, 11
	i32.ge_u	$push38=, $2, $pop37
	br_if   	0, $pop38
	i32.const	$push44=, 1
	i32.shl 	$push45=, $2, $pop44
	i32.store8	16($9), $pop45
	i32.const	$push141=, 16
	i32.add 	$push142=, $9, $pop141
	i32.const	$push166=, 1
	i32.or  	$push165=, $pop142, $pop166
...
.LBB5_10:
	...
	i32.const	$push41=, -16
	i32.and 	$push169=, $pop40, $pop41
	tee_local	$push168=, $3=, $pop169
	i32.call	$4=, _Znwj@FUNCTION, $pop168
	i32.const	$push42=, 1
	i32.or  	$push43=, $3, $pop42
	i32.store	16($9), $pop43
	i32.store	24($9), $4
	i32.store	20($9), $2
	i32.const	$push147=, 16
	i32.add 	$push148=, $9, $pop147
	i32.const	$push167=, 1
	i32.or  	$8=, $pop148, $pop167
.LBB5_11:
	end_block
	i32.const	$push46=, .L.str.7
	i32.call	$drop=, memcpy@FUNCTION, $4, $pop46, $2
.LBB5_12:
	end_block
	i32.add 	$push47=, $4, $2
	i32.const	$push48=, 0
	...
	i32.load	$7=, 20($9)
	i32.load8_u	$2=, 16($9)
	i32.load	$push53=, 40($9)
	i32.const	$push143=, 32
	i32.add 	$push144=, $9, $pop143
	i32.const	$push193=, 1
	i32.or  	$push192=, $pop144, $pop193
	tee_local	$push191=, $3=, $pop192
	i32.load8_u	$push190=, 32($9)
	tee_local	$push189=, $5=, $pop190
	i32.const	$push188=, 1
	i32.and 	$push187=, $pop189, $pop188
	tee_local	$push186=, $6=, $pop187
	i32.select	$push54=, $pop53, $pop191, $pop186
	i32.load	$push50=, 36($9)
	i32.const	$push185=, 1
	i32.shr_u	$push49=, $5, $pop185
	i32.select	$push51=, $pop50, $pop49, $6
	i32.const	$push184=, 1
	i32.add 	$push52=, $pop51, $pop184
	call    	pass_key@FUNCTION, $pop54, $pop52
	i32.const	$push183=, 1
	i32.and 	$push182=, $2, $pop183
	tee_local	$push181=, $5=, $pop182
	i32.select	$push58=, $4, $8, $pop181
	i32.const	$push180=, 1
	i32.shr_u	$push55=, $2, $pop180
	i32.select	$push56=, $7, $pop55, $5
	i32.const	$push179=, 1
	i32.add 	$push57=, $pop56, $pop179
	call    	set_value@FUNCTION, $pop58, $pop57
	block   	
	i32.load	$push62=, 40($9)
	i32.load8_u	$push178=, 32($9)
	tee_local	$push177=, $2=, $pop178
	i32.const	$push176=, 1
	i32.and 	$push175=, $pop177, $pop176
	tee_local	$push174=, $4=, $pop175
	i32.select	$push63=, $pop62, $3, $pop174
	i32.load	$push60=, 36($9)
	i32.const	$push173=, 1
	i32.shr_u	$push59=, $2, $pop173
	i32.select	$push61=, $pop60, $pop59, $4
	i32.call	$push172=, get_valueSize@FUNCTION, $pop63, $pop61
	tee_local	$push171=, $4=, $pop172
	i32.const	$push170=, 1
	i32.lt_s	$push64=, $pop171, $pop170
	br_if   	0, $pop64
	block   	
	block   	
	i32.const	$push65=, 513
	i32.lt_u	$push66=, $4, $pop65
	br_if   	0, $pop66
	i32.call	$10=, malloc@FUNCTION, $4
	br      	1
.LBB5_15:
	end_block
	i32.const	$push121=, 0
	...
	i32.sub 	$push195=, $10, $pop70
	tee_local	$push194=, $10=, $pop195
	copy_local	$push149=, $pop194
	i32.store	__stack_pointer($pop121), $pop149
.LBB5_16:
	end_block
	i32.const	$push145=, 32
	i32.add 	$push146=, $9, $pop145
	i32.const	$push76=, 8
	i32.add 	$push77=, $pop146, $pop76
	i32.load	$push78=, 0($pop77)
	i32.load8_u	$push204=, 32($9)
	tee_local	$push203=, $2=, $pop204
	i32.const	$push71=, 1
	i32.and 	$push202=, $pop203, $pop71
	tee_local	$push201=, $8=, $pop202
	i32.select	$push79=, $pop78, $3, $pop201
	i32.load	$push73=, 36($9)
	i32.const	$push200=, 1
	i32.shr_u	$push72=, $2, $pop200
	i32.select	$push74=, $pop73, $pop72, $8
	i32.const	$push199=, 1
	i32.add 	$push75=, $pop74, $pop199
	call    	pass_key@FUNCTION, $pop79, $pop75
	i32.call	$drop=, get_value@FUNCTION, $10, $4
	i32.const	$push198=, 8
	i32.add 	$push80=, $9, $pop198
	i32.const	$push81=, 0
	i32.store	0($pop80), $pop81
	i64.const	$push82=, 0
	i64.store	0($9), $pop82
	i32.const	$push83=, .L.str.8
	i32.call	$push197=, strlen@FUNCTION, $pop83
	tee_local	$push196=, $2=, $pop197
	i32.const	$push84=, -16
	i32.ge_u	$push85=, $pop196, $pop84
	br_if   	3, $pop85
	block   	
	block   	
	block   	
	i32.const	$push86=, 11
	i32.ge_u	$push87=, $2, $pop86
	br_if   	0, $pop87
	i32.const	$push93=, 1
	i32.shl 	$push94=, $2, $pop93
	i32.store8	0($9), $pop94
	i32.const	$push207=, 1
	i32.or  	$push206=, $9, $pop207
...
.LBB5_19:
	...
	i32.const	$push90=, -16
	i32.and 	$push210=, $pop89, $pop90
	tee_local	$push209=, $8=, $pop210
	i32.call	$3=, _Znwj@FUNCTION, $pop209
	i32.const	$push91=, 1
	i32.or  	$push92=, $8, $pop91
	i32.store	0($9), $pop92
	i32.store	8($9), $3
	i32.store	4($9), $2
	i32.const	$push208=, 1
...
.LBB5_20:
	end_block
	i32.const	$push95=, .L.str.8
	i32.call	$drop=, memcpy@FUNCTION, $3, $pop95, $2
.LBB5_21:
	end_block
	i32.add 	$push96=, $3, $2
	i32.const	$push97=, 0
	i32.store8	0($pop96), $pop97
	i32.call	$drop=, _ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6appendEPKc@FUNCTION, $9, $10
	i32.load	$push101=, 8($9)
	i32.load8_u	$push216=, 0($9)
	tee_local	$push215=, $2=, $pop216
	i32.const	$push214=, 1
	i32.and 	$push213=, $pop215, $pop214
	tee_local	$push212=, $3=, $pop213
	i32.select	$push102=, $pop101, $8, $pop212
	i32.load	$push99=, 4($9)
	i32.const	$push211=, 1
	i32.shr_u	$push98=, $2, $pop211
	i32.select	$push100=, $pop99, $pop98, $3
	call    	prints_l@FUNCTION, $pop102, $pop100
	block   	
	i32.const	$push103=, 513
	i32.lt_u	$push104=, $4, $pop103
	br_if   	0, $pop104
	call    	free@FUNCTION, $10
.LBB5_23:
	end_block
	i32.load8_u	$push105=, 0($9)
	i32.const	$push217=, 1
	i32.and 	$push106=, $pop105, $pop217
	i32.eqz 	$push220=, $pop106
	br_if   	0, $pop220
	i32.const	$push107=, 8
...
.LBB5_25:
	end_block
	block   	
	i32.load8_u	$push110=, 16($9)
	i32.const	$push218=, 1
	i32.and 	$push111=, $pop110, $pop218
	i32.eqz 	$push221=, $pop111
	br_if   	0, $pop221
	i32.const	$push112=, 24
	i32.add 	$push113=, $9, $pop112
	i32.load	$push114=, 0($pop113)
	call    	_ZdlPv@FUNCTION, $pop114
.LBB5_27:
	end_block
	block   	
	i32.load8_u	$push116=, 32($9)
	i32.const	$push115=, 1
	i32.and 	$push117=, $pop116, $pop115
	i32.eqz 	$push222=, $pop117
	br_if   	0, $pop222
...
.LBB5_30:
	...
	call    	_ZNKSt3__121__basic_string_commonILb1EE20__throw_length_errorEv@FUNCTION, $pop136
	unreachable
.LBB5_31:
	end_block
	i32.const	$push139=, 16
	i32.add 	$push140=, $9, $pop139
	call    	_ZNKSt3__121__basic_string_commonILb1EE20__throw_length_errorEv@FUNCTION, $pop140
	unreachable
.LBB5_32:
	end_block
	call    	_ZNKSt3__121__basic_string_commonILb1EE20__throw_length_errorEv@FUNCTION, $9
	unreachable
	.endfunc
.Lfunc_end5:
...
.Lfunc_end6:
	...
	.section	.text._ZNK5eosio4name9to_stringEv,"axG",@progbits,_ZNK5eosio4name9to_stringEv,comdat
	.hidden	_ZNK5eosio4name9to_stringEv
	.weak	_ZNK5eosio4name9to_stringEv
	.type	_ZNK5eosio4name9to_stringEv,@function
_ZNK5eosio4name9to_stringEv:
	.param  	i32, i32
...
.LBB7_1:
	loop    	
	i32.const	$push63=, 0
	i32.load	$push8=, _ZZNK5eosio4name9to_stringEvE7charmap($pop63)
	i64.const	$push62=, 15
	i64.const	$push61=, 31
	i32.const	$push60=, 12
...
.LBB7_13:
	...
	.endfunc
.Lfunc_end7:
	.size	_ZNK5eosio4name9to_stringEv, .Lfunc_end7-_ZNK5eosio4name9to_stringEv
...
.LBB9_25:
	...
	.endfunc
.Lfunc_end9:
	.size	_ZN5eosio14memory_manager6mallocEm, .Lfunc_end9-_ZN5eosio14memory_manager6mallocEm
...
.LBB10_22:
	...
	.endfunc
.Lfunc_end10:
	.size	_ZN5eosio14memory_manager16next_active_heapEv, .Lfunc_end10-_ZN5eosio14memory_manager16next_active_heapEv
...
_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6appendEPKc:
	...
	.endfunc
.Lfunc_end16:
	.size	_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6appendEPKc, .Lfunc_end16-_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6appendEPKc
...
.LBB17_15:
	...
	.endfunc
.Lfunc_end17:
	.size	_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6appendEPKcj, .Lfunc_end17-_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6appendEPKcj
...
.LBB18_16:
	...
	.endfunc
.Lfunc_end18:
	.size	_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE21__grow_by_and_replaceEjjjjjjPKc, .Lfunc_end18-_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE21__grow_by_and_replaceEjjjjjjPKc
...
.LBB19_7:
	...
	.endfunc
.Lfunc_end19:
	.size	_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEC2ERKS5_jjRKS4_, .Lfunc_end19-_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEC2ERKS5_jjRKS4_
...
.L.str.11:
	...
	.type	.L.str.3,@object
.L.str.3:
	.asciz	"Contract DB write and read for Hello , "
	.size	.L.str.3, 40

	.type	.L.str.4,@object
.L.str.4:
	.asciz	"\nWelcome to use our wasm contract platform!"
	.size	.L.str.4, 44

	.type	.L.str.5,@object
.L.str.5:
	.asciz	"It's developed by hezhengjun of Chain33.\n"
	.size	.L.str.5, 42
...
.L.str.7:
	...
	.type	.L.str.8,@object
.L.str.8:
	.asciz	"Contract DB retrieve value is: "
	.size	.L.str.8, 32

	.hidden	_ZZNK5eosio4name9to_stringEvE7charmap
	.type	_ZZNK5eosio4name9to_stringEvE7charmap,@object
	.section	.data._ZZNK5eosio4name9to_stringEvE7charmap,"aGw",@progbits,_ZZNK5eosio4name9to_stringEvE7charmap,comdat
	.weak	_ZZNK5eosio4name9to_stringEvE7charmap
	.p2align	2
_ZZNK5eosio4name9to_stringEvE7charmap:
	.int32	.L.str.9
	.size	_ZZNK5eosio4name9to_stringEvE7charmap, 4
