	.text
	.file	"/tmp/tmp.3Q0v3K9cQH/linked.bc"
...
_ZN5hello2hiEy:
	...
	i32.call	$push74=, strlen@FUNCTION, $pop4
	tee_local	$push73=, $2=, $pop74
	i32.const	$push5=, -16
	i32.ge_u	$push6=, $pop73, $pop5
	br_if   	0, $pop6
	block   	
	block   	
	block   	
	i32.const	$push7=, 11
	i32.ge_u	$push8=, $2, $pop7
	br_if   	0, $pop8
	i32.const	$push14=, 1
	i32.shl 	$push15=, $2, $pop14
	i32.store8	16($5), $pop15
	i32.const	$push69=, 16
	i32.add 	$push70=, $5, $pop69
	i32.const	$push77=, 1
	i32.or  	$3=, $pop70, $pop77
	br_if   	1, $2
	br      	2
.LBB5_3:
	end_block
	...
	i32.const	$push11=, -16
	i32.and 	$push79=, $pop10, $pop11
	tee_local	$push78=, $4=, $pop79
	i32.call	$3=, _Znwj@FUNCTION, $pop78
	i32.const	$push12=, 1
	i32.or  	$push13=, $4, $pop12
	i32.store	16($5), $pop13
	i32.store	24($5), $3
	i32.store	20($5), $2
.LBB5_4:
	end_block
	i32.const	$push16=, .L.str.3
	i32.call	$drop=, memcpy@FUNCTION, $3, $pop16, $2
.LBB5_5:
	end_block
	i32.add 	$push17=, $3, $2
	i32.const	$push18=, 0
	...
	i32.const	$push82=, 0
	i32.store	0($pop20), $pop82
	i64.const	$push21=, 0
	i64.store	0($5), $pop21
	i32.const	$push22=, .L.str.4
	i32.call	$push81=, strlen@FUNCTION, $pop22
	tee_local	$push80=, $2=, $pop81
	i32.const	$push23=, -16
	i32.ge_u	$push24=, $pop80, $pop23
	br_if   	1, $pop24
	block   	
	block   	
	block   	
	i32.const	$push25=, 11
	i32.ge_u	$push26=, $2, $pop25
	br_if   	0, $pop26
	i32.const	$push32=, 1
	i32.shl 	$push33=, $2, $pop32
	i32.store8	0($5), $pop33
	i32.const	$push85=, 1
	i32.or  	$push84=, $5, $pop85
...
.LBB5_8:
	...
	i32.const	$push29=, -16
	i32.and 	$push88=, $pop28, $pop29
	tee_local	$push87=, $4=, $pop88
	i32.call	$3=, _Znwj@FUNCTION, $pop87
	i32.const	$push30=, 1
	i32.or  	$push31=, $4, $pop30
	i32.store	0($5), $pop31
	i32.store	8($5), $3
	i32.store	4($5), $2
	i32.const	$push86=, 1
...
.LBB5_9:
	...
	i32.call	$drop=, memcpy@FUNCTION, $3, $pop34, $2
.LBB5_10:
	end_block
	i32.add 	$push35=, $3, $2
	i32.const	$push36=, 0
	i32.store8	0($pop35), $pop36
	i32.load	$push47=, 24($5)
	i32.const	$push71=, 16
	i32.add 	$push72=, $5, $pop71
	i32.const	$push102=, 1
	i32.or  	$push46=, $pop72, $pop102
	i32.load8_u	$push101=, 16($5)
	tee_local	$push100=, $2=, $pop101
	i32.const	$push99=, 1
	i32.and 	$push98=, $pop100, $pop99
	tee_local	$push97=, $3=, $pop98
	i32.select	$push48=, $pop47, $pop46, $pop97
	i64.extend_u/i32	$push49=, $pop48
	i32.load	$push41=, 20($5)
	i32.const	$push96=, 1
	i32.shr_u	$push40=, $2, $pop96
	i32.select	$push42=, $pop41, $pop40, $3
	i32.load	$push43=, 8($5)
	i32.load8_u	$push95=, 0($5)
	tee_local	$push94=, $2=, $pop95
	i32.const	$push93=, 1
	i32.and 	$push92=, $pop94, $pop93
	tee_local	$push91=, $3=, $pop92
	i32.select	$push44=, $pop43, $4, $pop91
	i64.extend_u/i32	$push45=, $pop44
	i32.load	$push38=, 4($5)
	i32.const	$push90=, 1
	i32.shr_u	$push37=, $2, $pop90
	i32.select	$push39=, $pop38, $pop37, $3
	call    	dbSet@FUNCTION, $pop49, $pop42, $pop45, $pop39
	block   	
	i32.load8_u	$push50=, 0($5)
	i32.const	$push89=, 1
	i32.and 	$push51=, $pop50, $pop89
	i32.eqz 	$push104=, $pop51
	br_if   	0, $pop104
	i32.const	$push52=, 8
...
.LBB5_12:
	end_block
	block   	
	i32.load8_u	$push55=, 16($5)
	i32.const	$push103=, 1
	i32.and 	$push56=, $pop55, $pop103
	i32.eqz 	$push105=, $pop56
	br_if   	0, $pop105
	i32.const	$push57=, 24
...
.LBB5_15:
	...
	call    	_ZNKSt3__121__basic_string_commonILb1EE20__throw_length_errorEv@FUNCTION, $pop68
	unreachable
.LBB5_16:
	end_block
	call    	_ZNKSt3__121__basic_string_commonILb1EE20__throw_length_errorEv@FUNCTION, $5
	unreachable
	.endfunc
.Lfunc_end5:
	.size	_ZN5hello2hiEy, .Lfunc_end5-_ZN5hello2hiEy
...
.LBB6_10:
	...
	.endfunc
.Lfunc_end6:
	.size	_ZN5eosio14execute_actionI5helloS1_JyEEEbPT_MT0_FvDpT1_E, .Lfunc_end6-_ZN5eosio14execute_actionI5helloS1_JyEEEbPT_MT0_FvDpT1_E
...
.LBB8_25:
	...
	.endfunc
.Lfunc_end8:
	.size	_ZN5eosio14memory_manager6mallocEm, .Lfunc_end8-_ZN5eosio14memory_manager6mallocEm
...
.LBB9_22:
	...
	.endfunc
.Lfunc_end9:
	.size	_ZN5eosio14memory_manager16next_active_heapEv, .Lfunc_end9-_ZN5eosio14memory_manager16next_active_heapEv
...
.L.str.6:
	...
	.type	.L.str.3,@object
.L.str.3:
	.asciz	"wasm contract key:Hello chain33."
	.size	.L.str.3, 33

	.type	.L.str.4,@object
.L.str.4:
	.asciz	"wasm contract value:Good luck!"
	.size	.L.str.4, 31
...
.L.str.1.3:
	...
	.functype	dbSet, void, i64, i32, i64, i32
	.functype	abort, void
