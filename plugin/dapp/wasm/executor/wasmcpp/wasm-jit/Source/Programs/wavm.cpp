...
#if 0
		std::string begin = fc::format_string("resolve in wavm.cpp:moduleName->${a}, exportName->${a},"
		"ObjectType->${a},ObjectInstance->${a},.\n",
		fc::mutable_variant_object()("a", moduleName)("b", exportName)("c", type)("d", outObject));
