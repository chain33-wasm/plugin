...
namespace eosio { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( gas_exhausted_exception, chain_exception,
                                 3080000, "Resource exhausted exception" )

      FC_DECLARE_DERIVED_EXCEPTION( gas_usage4db_exceeded, gas_exhausted_exception,
                                    3080001, "Account using more than gas buyed for db operation" )
      FC_DECLARE_DERIVED_EXCEPTION( gas_usage4normal_exceeded, gas_exhausted_exception,
                                    3080002, "Account using more than gas buyed for normal operation" )
