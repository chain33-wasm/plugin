...
//Convert json abi data to binary.The caller should responsible for freeing the memory
const char *genAbiFromJson(const char *contractName, const char *actionName, const char *contractAbi, const char *abijson, int *pAbisize);
