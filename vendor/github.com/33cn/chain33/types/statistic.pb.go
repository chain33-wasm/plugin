...
func (*TotalFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{0}
}
...
func (*ReqGetTotalCoins) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{1}
}
...
func (*ReplyGetTotalCoins) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{2}
}
...
func (*IterateRangeByStateHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{3}
}
...
func (*TicketStatistic) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{4}
}
...
func (*TicketMinerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{5}
}
...
func (*TotalAmount) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{6}
}
...
func (*ReqGetExecBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{7}
}
...
func (*ExecBalanceItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{8}
}
...
func (*ReplyGetExecBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_443d2ea8a11b471f, []int{9}
}
...
func init() { proto.RegisterFile("statistic.proto", fileDescriptor_statistic_443d2ea8a11b471f) }

var fileDescriptor_statistic_443d2ea8a11b471f = []byte{
