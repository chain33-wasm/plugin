...
func (*Account) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_c2caa06dbb0033e6, []int{0}
}
...
func (*ReceiptExecAccountTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_c2caa06dbb0033e6, []int{1}
}
...
func (*ReceiptAccountTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_c2caa06dbb0033e6, []int{2}
}
...
func (*ReqBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_c2caa06dbb0033e6, []int{3}
}
...
func (*Accounts) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_c2caa06dbb0033e6, []int{4}
}
...
func (*ExecAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_c2caa06dbb0033e6, []int{5}
}
...
func (*AllExecBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_c2caa06dbb0033e6, []int{6}
}
...
func init() { proto.RegisterFile("account.proto", fileDescriptor_account_c2caa06dbb0033e6) }

var fileDescriptor_account_c2caa06dbb0033e6 = []byte{
